/* =========================================================
 * Bulma year calendar v0.1
 * Based from Bootstrap year calendar v1.1.0 
 * (https://github.com/Paul-DS/bootstrap-year-calendar) by Paul David-Sivelle
 * =========================================================
 * Created by Peppe Lauro
 *
 ...
 * ========================================================= */
 ...
 (function($) {
	...
	Calendar.prototype = {
      ...
      monthsDiv.addClass('months-container columns is-desktop is-multiline');
			
			for(var m = 0; m < 12; m++) {
        //First and Second row of 6 months
        //if( m == 0 || m == 6) {
        //  var monthsRowDiv = $(document.createElement('div'));
        //  monthsRowDiv.addClass('columns is-desktop is-multiline');
        //}
        
				/* Container */
				var monthDiv = $(document.createElement('div'));
				monthDiv.addClass('month-container column is-3 is-inline-block');
        ...
        //monthsRowDiv.append(monthDiv);
        
        //if(m == 5 || m == 11) {
        //  monthsDiv.append(monthsRowDiv);
        //}
      ...
      //    //monthContainerClass += ' column is-narrow is-3';
			//	//}
			//	//else if(monthSize * 4 < calendarSize) {
			//	//	monthContainerClass += ' column ais-3';
			//	//}
			//	//else if(monthSize * 3 < calendarSize) {
			//	//	monthContainerClass += ' column ais-4';
			//	//}
			//	//else if(monthSize * 2 < calendarSize) {
			//	//	monthContainerClass += ' column ais-6';
			//	//}
			//	//else {
			//	//	monthContainerClass += ' column ais-12';
			//	//}
			//	
